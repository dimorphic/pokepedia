...
import EggRewards from 'shared/components/modules/EggRewards';
import LevelRewards from 'shared/components/modules/LevelRewards';

// style
if (process.env.BROWSER) require('./RewardsPage.scss');
